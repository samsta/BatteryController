...
#define CANHAT
   ...
   ID_INVERTER_SLEEP_AWAKE_COMMAND = 0x80008201,
   ID_INVERTER_CHARGE_DISCHARGE_COMMAND = 0x80008211,
   ID_INVERTER_SYSTEM_OPERATION = 0x80008261,
   ...
   ID_BATTERY_HWSW_VERSION = 0x80007311,
   ID_BATTERY_MODULE_CAPACITY = 0x80007321,
   ID_BATTERY_CONFIRM_OPERATION = 0x80008271
#else
   ID_INVERTER_INFO_REQUEST = 0x00004200,
   ID_INVERTER_SLEEP_AWAKE_COMMAND = 0x00008201,
   ID_INVERTER_CHARGE_DISCHARGE_COMMAND = 0x00008211,
   ID_INVERTER_SYSTEM_OPERATION = 0x00008261,
   ...
   ID_BATTERY_HWSW_VERSION = 0x00007311,
   ID_BATTERY_MODULE_CAPACITY = 0x00007321,
   ID_BATTERY_CONFIRM_OPERATION = 0x00008271
#endif
};
