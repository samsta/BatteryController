...
private:
   ...
   static constexpr uint8_t m_heartbeat_11A[4][8] = {{ 0x4E, 0x40, 0x04, 0xAA, 0xC0, 0x00, 0x00, 0xBD},
   ...
   static constexpr uint8_t m_0x55_crc_50c[4] = { 0xA6, 0x31, 0x0D, 0x9A };
   static constexpr uint8_t m_0xAA_crc_50c[4] = { 0xC8, 0x5F, 0x63, 0xF4 };
   static constexpr uint8_t m_hcm_clock_50c[6] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };

   static constexpr uint8_t m_vcm_1F2[4][8] = {{ 0x10, 0x64, 0x00, 0xB4, 0x00, 0x1E, 0x00, 0x83},
                              { 0x10, 0x64, 0x00, 0xB4, 0x00, 0x1E, 0x01, 0x84},
                              { 0x10, 0x64, 0x00, 0xB4, 0x00, 0x1E, 0x02, 0x85},
                              { 0x10, 0x64, 0x00, 0xB4, 0x00, 0x1E, 0x03, 0x86}};

   static constexpr uint8_t m_vcm_1D4[4][8] = {{ 0x6E, 0x6E, 0x00, 0x00, 0x07, 0x46, 0x21, 0xC0},
