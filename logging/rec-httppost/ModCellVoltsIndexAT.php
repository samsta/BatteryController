...
<BODY bgColor="#000000" text="#FFFFFF" link="#CCCFFF" vlink="#FFCCFF">
...
?>
<form autocomplete="off" action="ModCellVoltsActionAT.php"  method="post">
Start Time
...
<br>
<input type="Submit" value="Draw Chart" style="background-color: white; color: black;">
</form>
</font>
<!-- <br><A HREF="https://jimster.ca/BatteryTwo/index.php" >Main Menu</A> -->
</body>
</html>
